...
export default function Navbar({
  ...
  return (
    <nav
      className="pointer-events-auto fixed bottom-0 left-0 right-0 z-50 w-full border-t border-zinc-800 bg-zinc-950 pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-1px_0_0_rgba(24,24,27,0.65)]"
